                ...
                <div className="container banner-2">
                    <div className="banner-box">
                        <div className="col-img">
                            <a href="#"><img src="/public/assets/img/banner/banner3-1.jpg" alt="banner 3"/></a>
                        </div>
                        <div className="col-img">
                            <a href="#"><img src="/public/assets/img/banner/banner3-2.jpg" alt="banner 3"/></a>
                        </div>
                    </div>
                    <div className="banner-box">
                        <div className="col-img">
                            <a href="#"><img src="/public/assets/img/banner/banner3-3.jpg" alt="banner 3"/></a>
                        </div>
                    </div>
                    <div className="banner-box">
                        <div className="col-img">
                            <a href="#"><img src="/public/assets/img/banner/banner3-4.jpg" alt="banner 3"/></a>
                        </div>
                        <div className="col-img">
                            <a href="#"><img src="/public/assets/img/banner/banner3-5.jpg" alt="banner 3"/></a>
                        </div>
                    </div>
                    <div className="banner-box">
                        <div className="col-img">
                            <a href="#"><img src="/public/assets/img/banner/banner3-6.jpg" alt="banner 3"/></a>
                        </div>
                    </div>
                    <div className="banner-box">
                        <div className="col-img">
                            <a href="#"><img src="/public/assets/img/banner/banner3-7.jpg" alt="banner 3"/></a>
                        </div>
                        <div className="col-img">
                            <a href="#"><img src="/public/assets/img/banner/banner3-8.jpg" alt="banner 3"/></a>
                        </div>
                    </div>
                </div>
            </div>
